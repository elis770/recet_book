...
abstract class AppLocalizations {
  ...
  /// No description provided for @recipeBy.
  ///
  /// In en, this message translates to:
  /// **'By: {creator}'**
  String recipeBy(String creator);

  /// No description provided for @detailsFromApi.
  ///
  /// In en, this message translates to:
  /// **'Details from TheMealDB'**
  String get detailsFromApi;

  /// No description provided for @errorLoadingDetails.
  ///
  /// In en, this message translates to:
  /// **'Error loading details from API'**
  String get errorLoadingDetails;

  /// No description provided for @noDetailsFound.
  ///
  /// In en, this message translates to:
  /// **'No recipes found on TheMealDB.'**
  ...
  /// No description provided for @errorCreatorRequired.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @errorInstructionsRequired.
  ///
  /// In en, this message translates to:
  /// **'Please enter instructions'**
  String get errorInstructionsRequired;
  ...
  /// No description provided for @errorImageRequired.
  ///
  /// In en, this message translates to:
  /// **'Please enter an image URL'**
  String get errorImageRequired;
  ...
  /// No description provided for @labelAreaWithTitle.
  ///
  /// In en, this message translates to:
  /// **'Area: {area}'**
  String labelAreaWithTitle(String area);

  /// No description provided for @labelInstructionsTitle.
  ///
  /// In en, this message translates to:
  /// **'Instructions:'**
  String get labelInstructionsTitle;
